...
function newDrawing(recievedData) {
  context.fillStyle = "rgb(" + recievedData.red + "," + recievedData.green + "," + recievedData.blue + ")";
  context.fillRect(recievedData.finalX, recievedData.finalY, pixelSize, pixelSize);
  data = recievedData;
  addInfo();
}
